...
func main() {
	...
	// Clear any transient settings conflict warnings (-221) from the error
	// queue so the instrument display doesn't show "Error generated by remote
	// interface" to test operators.
