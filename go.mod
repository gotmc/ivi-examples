...
require (
	github.com/gotmc/asrl v0.7.0
	github.com/gotmc/ivi v0.11.0
	github.com/gotmc/lxi v0.5.1
	github.com/gotmc/prologix v0.7.0
	github.com/gotmc/usbtmc v0.8.0
	github.com/gotmc/visa v0.9.0
)

require (
	github.com/creack/goselect v0.1.2 // indirect
	github.com/google/gousb v1.1.3 // indirect
	github.com/gotmc/convert v0.4.0 // indirect
	github.com/gotmc/query v0.5.1 // indirect
